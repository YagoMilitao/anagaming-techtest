      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        {odd.bookmakers.map((bookmaker) => (
          <div key={bookmaker.key} className="mb-4 border p-4 rounded-md">
            ...
            {Array.isArray(bookmaker.markets) && bookmaker.markets.map((market, index) => (
              <div key={market.key || index} className="flex flex-wrap gap-4 mt-2"> 
                <span className="font-semibold text-gray-700">{market.key?.toUpperCase() || 'Mercado Desconhecido'}:</span>
