  ...
  describe("generateMetadata", () => {
    it("should generate correct metadata when odd data is available", async () => {
      ...
      expect(metadata.description).toContain(
        "Acompanhe as odds ao vivo e informações detalhadas para o jogo de Soccer Epl: Manchester United vs Liverpool.",
      );
      ...
      expect(metadata.openGraph?.url).toBe(
        `https://anagaming-techtest.vercel.app/sports/${mockParams.sport}/${mockParams.id}`,
      );
