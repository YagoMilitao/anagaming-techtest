...
describe("useOddsHomeViewModel", () => {
  ...
  const initialOdds: Odd[] = [
    {
      ...
      sport_key: "soccer",
      sport_title: "Soccer",
      commence_time: "2025-06-02T22:00:00Z",
      home_team: "Team A",
      away_team: "Team B",
      bookmakers: [],
    },
    {
      ...
      commence_time: "2025-06-02T18:00:00Z",
      home_team: "Team C",
      away_team: "Team D",
      bookmakers: [],
    },
    {
      ...
      sport_key: "soccer",
      sport_title: "Soccer",
      commence_time: "2025-06-01T10:00:00Z",
      home_team: "Team E",
      away_team: "Team F",
      bookmakers: [],
    }, // Finished
  ...
  beforeEach(() => {
    ...
    mockSortOddsByCommenceTimeAsc.mockImplementation((arr) =>
      [...arr].sort((a, b) => new Date(a.commence_time).getTime() - new Date(b.commence_time).getTime()),
    );
    mockSortOddsByCommenceTimeDesc.mockImplementation((arr) =>
  ...
  it("should re-filter and re-categorize when selectedSport changes", () => {
    const { rerender, result } = renderHook(
      ({ initialOdds, serverRenderedTimestamp }) => useOddsHomeViewModel({ initialOdds, serverRenderedTimestamp }),
  ...
  it("should reset odds to initialOdds when initialOdds prop changes", () => {
    ...
    const newInitialOdds: Odd[] = [
      {
        id: "4",
        sport_key: "rugby",
        sport_title: "Rugby",
        commence_time: "2025-06-03T10:00:00Z",
        home_team: "Team G",
        away_team: "Team H",
        bookmakers: [],
      },
