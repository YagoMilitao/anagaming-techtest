  ...
  describe('getBestOdds', () => {
          ...
          markets: [
            {
              ...
              outcomes: [{ name: 'Over', price: 1.8 }, { name: 'Under', price: 2.0 }],
            },
          ],
        },
      ];
    ...
    it('should find the best odds for each distinct outcome across multiple bookmakers', () => {
          ...
          markets: [
            {
              key: 'h2h',
              outcomes: [
                { name: 'Team A', price: 2.10 }, // Melhor para Team A
                { name: 'Draw', price: 3.10 },
                { name: 'Team B', price: 3.40 },
              ],
            },
          ],
        },
          ...
          markets: [
            {
              ...
              outcomes: [
                ...
                { name: 'Draw', price: 3.30 }, // Melhor para Draw
                { name: 'Team B', price: 3.60 }, // Melhor para Team B
              ],
            },
          ],
        },
      ...
      const expected: BestOutcomeDetail[] = [
        { name: 'Team A', price: 2.10, bookmakerName: 'Paddy Power' },
        { name: 'Draw', price: 3.30, bookmakerName: 'William Hill' },
        { name: 'Team B', price: 3.60, bookmakerName: 'William Hill' },
      ];
    ...
    it('should handle outcomes with the same name from different bookmakers correctly', () => {
          ...
          markets: [
            {
              key: 'h2h',
              outcomes: [
                { name: 'Home', price: 1.60 }, // Melhor Home odd
      ...
      const expected: BestOutcomeDetail[] = [
        { name: 'Home', price: 1.60, bookmakerName: 'Bookie B' },
        { name: 'Away', price: 2.50, bookmakerName: 'Bookie A' },
      ];
  ...
  describe('getBestTeamOdds', () => {
    ...
    it('should correctly identify and return best odds for home and away teams when draw is not present', () => {
      const mockBestOutcomes: BestOutcomeDetail[] = [
        { name: 'Flamengo', price: 2.10, bookmakerName: 'Bookie A' },
        { name: 'Vasco', price: 3.50, bookmakerName: 'Bookie B' },
      ];
    ...
    it('should correctly identify and return best odds for home, away, and draw', () => {
      const mockBestOutcomes: BestOutcomeDetail[] = [
        { name: 'Flamengo', price: 1.80, bookmakerName: 'BetX' },
        { name: 'Vasco', price: 4.20, bookmakerName: 'SportsBook' },
        { name: 'Draw', price: 3.00, bookmakerName: 'Paddles' },
      ];
      mockGetBestOdds.mockReturnValue(mockBestOutcomes);
    ...
    it('should handle cases where only some outcomes are found', () => {
      const mockBestOutcomes: BestOutcomeDetail[] = [
        { name: 'Flamengo', price: 1.90, bookmakerName: 'OnlyHome' },
      ];
      mockGetBestOdds.mockReturnValue(mockBestOutcomes);
